...
class ImageInterpolator(Filter):
    ...
    def inference_linear(self, model, channel1, channel2, nFrames, half=False):
    ...
    def inference_adaptive(self, model, channel1, channel2, nFrames, half=False):
      img_batch_1, crop_region_1 = to_padded_rgb(channel1)
      img_batch_2, crop_region_2 = to_padded_rgb(channel2)
    ...
    def _update(self):
        ...
        for i in range(0,len(images)-1):
          ...
          if adaptive:
            rgbaI = self.inference_adaptive( model, rgba1, rgba2, nFrames )
          else:
            rgbaI = self.inference_linear( model, rgba1, rgba2, nFrames )
