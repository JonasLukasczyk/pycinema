...
vf2.insertView( 2, pycinema.theater.views.NodeEditorView() )
vf2.setSizes([1376, 1331, 1966])
vf0.setSizes([435, 4681])
...
ShaderFXAA_1 = pycinema.filters.ShaderFXAA()
...
ImageView_1.inputs.images.set(ShaderLineAO_0.outputs.images, False)
...
ShaderSSAO_0.inputs.images.set(ShaderLineAO_0.outputs.images, False)
ShaderSSAO_0.inputs.radius.set(0.06, False)
ShaderSSAO_0.inputs.samples.set(128, False)
ShaderSSAO_0.inputs.diff.set(0.5, False)
ImageAnnotation_0.inputs.images.set(ShaderFXAA_1.outputs.images, False)
...
ShaderLineAO_0.inputs.samples.set(128, False)
...
ShaderFXAA_1.inputs.images.set(ShaderSSAO_0.outputs.images, False)
